"""BaseWorker - Abstract base class for Recommender workers.
...
class BaseWorker(ABC):
    """Abstract base class for all Recommender workers.
    ...
    def __init__(self, worker_name: str):
        self.worker_name = worker_name
        self.logger = get_logger(f"recommender.workers.{worker_name}")
