"""Window Function Worker - Calculates rolling window operations."""
...
class WindowFunctionWorker(BaseWorker):
    """Worker that calculates rolling window functions on data."""
    
    def __init__(self):
        """Initialize WindowFunctionWorker."""
        super().__init__("WindowFunctionWorker")
