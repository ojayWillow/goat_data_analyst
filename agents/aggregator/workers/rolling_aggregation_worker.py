"""Rolling Aggregation Worker - Performs rolling aggregations across columns."""
...
class RollingAggregationWorker(BaseWorker):
    """Worker that performs rolling aggregations on multiple columns."""
    
    def __init__(self):
        """Initialize RollingAggregationWorker."""
        super().__init__("RollingAggregationWorker")
