"""CSV Streaming Worker - Handles large CSV files with chunked reading."""
...
class CSVStreamingWorker(BaseWorker):
    """Worker that streams large CSV files for memory efficiency."""
    
    def __init__(self):
        """Initialize CSVStreamingWorker."""
        super().__init__("CSVStreamingWorker")
